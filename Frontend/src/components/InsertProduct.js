    ...
    return (
        <div className='container-fluid p-5'>
            ...
            <div className='d-flex justify-content-center col-lg-6 col-md-6'>
                <NavLink to="/products" className='btn btn-primary me-5 fs-4 mt-5'>Cancel</NavLink>
                <button type="submit" onClick={addProduct} className="btn btn-primary fs-4 mt-5" disabled={loading}>{loading ? 'Inserting...' : 'Insert'}</button>
            </div>
